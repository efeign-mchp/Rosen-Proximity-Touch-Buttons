...
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		Y(7) | Y(13) | Y(3) | Y(8), Y(2), 10, PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_8), FILTER_LEVEL_16               \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		Y(7) | Y(13) | Y(8) | Y(2), Y(3), 10, PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_8), FILTER_LEVEL_16               \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		Y(7) | Y(3) | Y(8) | Y(2), Y(13), 5, PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16                \
	}
#define NODE_3_PARAMS                                                                                                  \
	{                                                                                                                  \
		Y(7) | Y(13) | Y(3) | Y(2), Y(8), 5, PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_2), FILTER_LEVEL_16                \
	}
...
/**********************************************************/
//#define DEF_TOUCH_DATA_STREAMER_ENABLE 1u	// defined in Project / Properties / Toolchain / AVR/GNU C Compiler / Symbols for DataVisualizer configuration
